...
export function buildOpenApiDocument(routes: RouteSpec[]): OpenApiDocument {
  ...
  return {
    ...
    info: {
      title: "EduVerify API",
      description:
        "Verification API for South African institutions and qualifications, backed by the " +
        "eduverify-institutions DynamoDB table. Every route requires the x-api-key header except " +
        "/v1/health, /v1/docs, and /v1/openapi.yaml. This file is generated by " +
        "`npm run docs:generate` (src/docs/generateOpenApi.ts) from src/docs/routeSpec.ts and the " +
        "TS types it references — do not hand-edit it.",
      version: "0.0.1",
    },
    servers: [
      {
